...
if modes_aliases[selected_mode.lower()] == "regular" or modes_aliases[selected_mode.lower()] == "semi":
    ...
    if modes_aliases[selected_mode.lower()] == "regular" :
        ...
        while not semi_select in semi_modes: semi_select = input("Which Semi-Automatic Mode do you want (Portrait or Sports): ").lower()
...
else: print("Automatic not dont yet sorry! :(")