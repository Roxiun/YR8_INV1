...
inputs = {}
# Creates a dictionary for the inputs
for item in all_inputs:
    if item == user_selected.lower():
        ...
        while not isValid:
            ...
            user_in = user_in.replace("f/" ,"").replace(".0", "")
...
print(f"Required {user_selected} Value: {reference_numbers[str(req_ref)][user_selected.title()]}")