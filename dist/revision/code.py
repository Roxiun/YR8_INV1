...
all_inputs = ["lighting", "iso", "shutter", "aperture"]; inputs_aliases = {"lighting":"Lighting Condtion" ,"iso":"ISO", "aperture":"Aperture", "shutter":"Shutter Speed"};
...
for item in all_inputs:
    if item == user_selected.lower().replace("lighting condition", "lighting").replace("shutter speed", "shutter"):
        ...
        isValid = False
        while not isValid:
            user_in = input(f"Enter your selected setting for {inputs_aliases[item.lower()]}: ")
